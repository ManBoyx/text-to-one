    ...
    submenu: [
      ...(avecZoom
        ? [
            ...
            action('Mode concentration', 'view:focus', { accelerator: 'CmdOrCtrl+Shift+F' }),
            séparateur,
          ]
        : []),
      thème,
  ...
  const menuTexte: MenuItemConstructorOptions[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        action('Son ou vidéo…', 'insert:media'),
        action('Date du jour', 'insert:date', { accelerator: 'CmdOrCtrl+Shift+D' }),
        action('Sommaire', 'insert:toc'),
  ...
  const menuTableur: MenuItemConstructorOptions[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        séparateur,
        action('Son ou vidéo dans la cellule…', 'sheet:insert-media'),
        séparateur,
  ...
  const menuPrésentation: MenuItemConstructorOptions[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        action('Son ou vidéo…', 'slides:insert-media'),
      ],
    },
    {
      label: 'Diapositive',
